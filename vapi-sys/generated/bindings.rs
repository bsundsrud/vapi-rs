...
pub const VSM_n_USAGE: &[u8; 18] = b"[-n varnish_name]\0";
pub const VSM_t_USAGE: &[u8; 19] = b"[-t <seconds|off>]\0";
...
pub const VSL_CLASS: &[u8; 4] = b"Log\0";
...
pub const VSL_COPT_TAIL: u32 = 1;
pub const VSL_COPT_BATCH: u32 = 2;
pub const VSL_COPT_TAILSTOP: u32 = 4;
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of VSC_point"][::std::mem::size_of::<VSC_point>() - 64usize];
...
const _: () = {
    ...
    ["Offset of field: vsm_fantom::class"][::std::mem::offset_of!(vsm_fantom, class) - 32usize];
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of VSLC_ptr"][::std::mem::size_of::<VSLC_ptr>() - 16usize];
    ["Alignment of VSLC_ptr"][::std::mem::align_of::<VSLC_ptr>() - 8usize];
    ["Offset of field: VSLC_ptr::ptr"][::std::mem::offset_of!(VSLC_ptr, ptr) - 0usize];
    ["Offset of field: VSLC_ptr::priv_"][::std::mem::offset_of!(VSLC_ptr, priv_) - 8usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of VSL_cursor"][::std::mem::size_of::<VSL_cursor>() - 32usize];
    ["Alignment of VSL_cursor"][::std::mem::align_of::<VSL_cursor>() - 8usize];
    ["Offset of field: VSL_cursor::rec"][::std::mem::offset_of!(VSL_cursor, rec) - 0usize];
    ["Offset of field: VSL_cursor::priv_tbl"]
        [::std::mem::offset_of!(VSL_cursor, priv_tbl) - 16usize];
    ["Offset of field: VSL_cursor::priv_data"]
        [::std::mem::offset_of!(VSL_cursor, priv_data) - 24usize];
};
...
pub type VSL_transaction_e = ::std::os::raw::c_uint;
...
pub type VSL_reason_e = ::std::os::raw::c_uint;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of VSL_transaction"][::std::mem::size_of::<VSL_transaction>() - 32usize];
    ["Alignment of VSL_transaction"][::std::mem::align_of::<VSL_transaction>() - 8usize];
    ["Offset of field: VSL_transaction::level"]
        [::std::mem::offset_of!(VSL_transaction, level) - 0usize];
    ["Offset of field: VSL_transaction::vxid"]
        [::std::mem::offset_of!(VSL_transaction, vxid) - 4usize];
    ["Offset of field: VSL_transaction::vxid_parent"]
        [::std::mem::offset_of!(VSL_transaction, vxid_parent) - 8usize];
    ["Offset of field: VSL_transaction::type_"]
        [::std::mem::offset_of!(VSL_transaction, type_) - 12usize];
    ["Offset of field: VSL_transaction::reason"]
        [::std::mem::offset_of!(VSL_transaction, reason) - 16usize];
    ["Offset of field: VSL_transaction::c"][::std::mem::offset_of!(VSL_transaction, c) - 24usize];
};
...
pub type VSL_grouping_e = ::std::os::raw::c_uint;
...
>;
unsafe extern "C" {
    pub static VSL_tags: [*const ::std::os::raw::c_char; 256usize];
}
unsafe extern "C" {
    pub static VSL_tagflags: [::std::os::raw::c_uint; 256usize];
}
unsafe extern "C" {
    pub fn VSL_Name2Tag(
...
unsafe extern "C" {
    pub static mut VSLQ_grouping: [*const ::std::os::raw::c_char; 4usize];
}
unsafe extern "C" {
...
pub type vsl_check = ::std::os::raw::c_int;
unsafe extern "C" {
