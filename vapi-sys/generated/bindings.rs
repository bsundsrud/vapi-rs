...
pub const VSM_n_USAGE: &'static [u8; 18usize] = b"[-n varnish_name]\0";
pub const VSM_t_USAGE: &'static [u8; 19usize] = b"[-t <seconds|off>]\0";
...
extern "C" {
    pub static mut VSM_invalid: [vsm_valid; 0usize];
}
extern "C" {
    pub static mut VSM_valid: [vsm_valid; 0usize];
}
extern "C" {
