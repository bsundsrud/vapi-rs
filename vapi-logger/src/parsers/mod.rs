...
pub fn timestamp(tag: String, value: &str) -> Result<(String, Timestamp)> {
...
pub fn header(_tag: String, value: &str) -> Result<(String, String)> {
...
pub fn req_accounting(tag: String, value: &str) -> Result<(String, RequestAccounting)> {
...
pub fn link(tag: String, value: &str) -> Result<(String, VarnishLink)> {
...
pub fn ttl(tag: String, value: &str) -> Result<(String, VarnishTtl)> {
